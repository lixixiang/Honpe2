 ...
 * 描述:
 */
public class FragmentChild2 extends BaseFragment {
    ...
    public static FragmentChild2 newInstance(List<StatisticsBean3.DataBean.DetailsBean> list) {
        FragmentChild2 fragmentChild = new FragmentChild2();
