package com.example.lxx.myalipay.ui.staff.query.ui.position2;
...
import com.example.lxx.myalipay.ui.staff.query.ui.position2.add.AddLeaveFragment;
...
/**
 * created by lxx at 2019/12/3 11:21
 * 描述:请假
 */
public class LeaveFragment extends BaseBackFragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private int mIndex;
    private String sign,types,mTypes;
    public static int CALENDAR = 1;

    public static LeaveFragment newInstance(String title) {
                                            ...
                                            switch (view.getId()) {
                                                case R.id.tv_morning:
                                                    if (mList.get(position).getMorning().equals("\ue611")) {
                                                        startForResult(AddLeaveFragment.newInstance(titles,mList.get(position),sign,types), 222);
    ...
    private void showPopupWindow(final BaseQuickAdapter adapter, final int position, boolean b) {
        ...
        dialog.setOnMobListener(new CustomTypeDialog.onMobClassListener() {
            ...
            public void onClickMobClass() {
                sign = "2";
                types = "0";
                startForResult(AddLeaveFragment.newInstance(titles,mList.get(position),sign,types), 2221);
            }
        });
