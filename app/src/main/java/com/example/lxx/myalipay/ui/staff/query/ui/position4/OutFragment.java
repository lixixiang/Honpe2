package com.example.lxx.myalipay.ui.staff.query.ui.position4;
...
/**
 * created by lxx at 2019/12/3 14:14
 * 描述:外出
 */
public class OutFragment extends BaseBackFragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public static OutFragment newInstance(String title) {
                                            ...
                                            switch (view.getId()) {
                                                case R.id.tv_morning:
                                                    if (mList.get(position).getMorning().equals("\ue611")) {
                                                        startForResult(AddTripFragment.newInstance(titles,mList.get(position),sign,types), 444);
    ...
    private void showPopupWindow(final BaseQuickAdapter adapter, final int position, boolean b) {
        ...
        dialog.setOnMobListener(new CustomTypeDialog.onMobClassListener() {
            ...
            public void onClickMobClass() {
                sign = "2";
                types = "2";
                startForResult(AddTripFragment.newInstance(titles,mList.get(position),sign,types), 4441);
            }
        });
    }
    ...
    public void onFragmentResult(int requestCode, int resultCode, Bundle data) {
        ...
        } else if (requestCode == 4441 && resultCode == RESULT_OK && data != null) {
            initRecyclerView();
            adapter.notifyDataSetChanged();
        }
    }
