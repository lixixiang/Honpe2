...
public class BottomBarTab extends FrameLayout {
    ...
    private void init(Context context, int icon, CharSequence title) {
        ...
        mTvTitle.setTextSize(TypedValue.COMPLEX_UNIT_PX,getFontSize(40));
        mTvTitle.setTextColor(ContextCompat.getColor(context,R.color.grey));
        ...
        mTvUnreadCount.setBackgroundResource(R.drawable.shape_rectangle_blue_white_radius10);
    ...
    public void setSelected(boolean selected) {
        ...
        if (selected){
            ...
            mIcon.setColorFilter(ContextCompat.getColor(mContext,R.color.grey_c9));
            mTvTitle.setTextColor(ContextCompat.getColor(mContext,R.color.grey_c9));
        }
    }
